<template>
  ...
  <p class="sdp">Component Diagram List</p>
  ...
  <div class="demo-image__placeholder">
    <p class="sd">Component Diagram</p>
    <div class="block">
      <el-image :src="require('../assets/CD/' + imageUrl)"></el-image>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    UploadSD() {
      ...
      axios.post('http://localhost:8077/sscm/uploadcd').then(response => {
        ...
        this.$message({
          message: "Generating Component Diagram Success!",
          type: 'success'
        })
      });
    },
